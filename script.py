                                    ...
                                    if itm == "parameters":
                                        for para in req[header][itm]:
                                            if para == "otp":
                                                ...
                                                print (req[header][itm][para])
                                                if p.match(str(req[header][itm][para])):
                                                    respo = {"fulfillmentText": "Otp verified Sucessfully, What are you Looking for?","fulfillmentMessages": [{"card": {"title": "New Loan","buttons": [{"text": "Apply Loan","postback": "apply loan"},{"text": "Track Loan Status","postback": "Track loan Status"}]}}],"source": "example.com","payload": {},"outputContexts": [ ],"followupEventInput": {}}
                                                    return jsonify(respo)                    
                                                else:
